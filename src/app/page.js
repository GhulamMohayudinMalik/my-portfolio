  ...
  return (
    <div>
      ...
      <hr className="w-4/5 border-t border-white flex mx-auto"/>
        <section id="certifications">
          <div className="w-4/5 mx-auto my-16 py-8">
            ...
            <p>
              I believe in lifelong learning and consistently invest time in
              upskilling through hands-on platforms and courses. Here are some
              of the certifications and learning programs I've completed or am
              currently pursuing.
            </p>
      ...
      <hr className="w-4/5 border-t border-gray-500 flex mx-auto"/>
        <section id="contact">
          <div className="w-3/5 mx-auto my-16 py-8 border text-center text-lg">
            <h1 className={`text-4xl  ${rubicGlitch.className}`}>Contact Me</h1>
            <p>
              Whether you want to collaborate, have a project idea, or just want
              to say hi — I’m always open to interesting conversations.
            </p>
